      ...
      <div class="col-12 d-flex align-items-center justify-content-center">
        <div class="bg-white shadow border-0 rounded border-light p-4 p-lg-5 w-100 fmxw-500">
          <div class="text-center text-md-center mb-4 mt-md-0">
            <h1 class="mb-0 h3">{{ __('Sign in') }}</h1>
          </div>
            ...
            <div class="form-group mb-4">
              ...
              <div class="input-group">
                ...
                <input type="email" class="form-control @error('email') is-invalid @enderror" name="email"
                  value="{{ old('email') }}" placeholder="bontangbarat@umkm.gis" id="email" autofocus required
                  autocomplete="email">
          ...
          <div class="d-flex justify-content-center align-items-center mt-4 mb-0">
            <span class="fw-bolder" style="color: #988f8f; font-size: 14px">
              SIG UMKM - Bontang Barat
            </span>
          </div>
        </div>
      </div>
