          ...
          <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                ...
                <a class="dropdown-item" href="{{ route('admin.kelurahan.index') }}">{{ __('Kelurahan') }}</a>
                <a class="dropdown-item" href="{{ route('admin.kelompok_usaha.index') }}">{{ __('Kelompok Usaha') }}</a>
                <a class="dropdown-item" href="{{ route('admin.umkm.index') }}">{{ __('UMKM') }}</a>
              </div>
            </li>
            @endif
            <li class="nav-item dropdown">
