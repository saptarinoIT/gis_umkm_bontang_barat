...
@section('title-item', 'Ubah Data Users')
@section('title-content', 'Ubah Data Users')

@section('main-content')
<h5 class="py-3"> {{ __('Ubah Data Users') }}</h5>
  ...
  <div class="row mb-3">
    ...
    <div class="col-md-9">
      <select name="level" id="level" class="form-select @error('level') is-invalid @enderror" required
        ...
        <option value="umkm" {{ ($user->level == 'umkm') ? 'selected' : '' }}>UMKM</option>
      </select>
