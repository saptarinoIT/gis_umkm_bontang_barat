...
<div class="d-flex justify-content-between align-items-center mb-3">
  <h5>{{ __('Data UMKM') }}</h5>
  <a href="{{ route('admin.umkm.create') }}" class="btn btn-sm btn-primary">Tambah Data</a>
</div>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td class="d-flex" style="column-gap: 4px">
          <a href="{{ route('admin.umkm.show', $umkm->id) }}" class="btn btn-sm btn-outline-info">Lihat</a>
          <a href="{{ route('admin.umkm.edit', $umkm->id) }}" class="btn btn-sm btn-outline-warning">Ubah</a>
